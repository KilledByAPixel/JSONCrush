...
* The JSCrush algorithm helps to eliminate repeated substrings similar to the zip algorithm.
...
* To compress longish strings (<10K characters) so they can be shared and bookmarked easily.
