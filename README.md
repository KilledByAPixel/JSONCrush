...
* To compress longish strings (~10000 characters) so they can be shared and bookmarked easily.
...
### JSONCrushed - 82 bytes! 60% smaller
...
### JSONCrushed - 1195 bytes! 75% smaller then URI encoded JSON
